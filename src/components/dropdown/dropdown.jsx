const SelectDropdown = (props) =>{
    return(
        <div className={props.parentClassName}>
            ...
            <select name={props.name} id={props.id} className={`cursor-pointer outline-none text-[#8890B1] sm:bg-transparent bg-white sm:px-0 sm:py-2 py-4 px-2 rounded-xl ${props.selectClassName}`}>
